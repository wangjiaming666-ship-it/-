...
风险规则用于专科智能体和安全审核智能体：专科智能体在诊断评估阶段解释异常检验的临床意义，安全审核智能体在方案筛查阶段对候选方案进行风险扣分。风险规则不用于替代临床指南。
...
安全审核智能体根据检验、既往史、肾功能、凝血、肝功能、电解质、微生物和 ICU 风险等因素，对候选方案进行安全筛查。

它输出最终方案、排序方案、触发风险和安全总结。
